...
public class DialogStageInsert extends Stage {


    // TODO FAZER SAPORRA MAIS BONITO
    ...
    public DialogStageInsert(String title, int width, int height) {
        ...
        //Set Aligment to center of the screen
        grid.setAlignment(Pos.CENTER);


        insert = new Button("Inserir");
        remove = new Button("Cancelar");
